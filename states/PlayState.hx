...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Marvelous!', 1] //The value on this one isn't used actually, since Marvelous is always "1"
	];
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'MainStage': new StageErect(); 			//Week 1
			case 'Philly-Erect': new PhillyErect();	//Week 3	
			case 'phillyStreets': new PhillyStreets(); 	//Weekend 1 - Darnell, Lit Up, 2Hot
			case 'Tank-Erect': new TankErect(); 			//Week 7
		}
		...
		botplayTxt = new FlxText(400, healthBar.y - 90, FlxG.width - 800, Language.getPhrase("Lucas Smb").toUpperCase(), 32);
	...
	public dynamic function updateScoreText()
	{
		...
		if(!instakillOnMiss) tempScore = Language.getPhrase('score_text', 'Score:{1} | Rating:{3}', [songScore, songMisses, str]);
	...
	public function endSong()
	{
		...
		if(ret != LuaUtils.Function_Stop && !transitioning)
		{
			...
			{
				trace('YOU ARE BACK TO FREEPLAY');
				Mods.loadTopMod();
				#if DISCORD_ALLOWED DiscordClient.resetClientID(); #end
