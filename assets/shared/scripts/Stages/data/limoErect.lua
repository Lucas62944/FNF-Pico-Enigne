function onCreate()
	makeLuaSprite('sunset', 'Stages/Week4/Erect/limoSunset', -220, -80)
	scaleObject('sunset', 0.9, 0.9)
	setScrollFactor('sunset', 0.1, 0.1)
	addLuaSprite('sunset')

	makeAnimatedLuaSprite('shootingStar', 'Stages/Week4/Erect/shooting star', 200, 0)
	...
	if lowQuality == false then
		makeAnimatedLuaSprite('limoBG', 'Stages/Week4/Erect/bgLimo', -200, 480)
	...
	makeAnimatedLuaSprite('limo', 'Stages/Week4/Erect/limoDrive', -120, 520)
...
function onCreatePost()
	if lowQuality == false then
        ...
        for mistNum, data in ipairs(mistData) do
            for i = 0, 2 do
                makeLuaSprite('mist'..mistNum..''..(i + 1), 'Stages/Week4/Erect/'..data.mistImage, -650, -100)
