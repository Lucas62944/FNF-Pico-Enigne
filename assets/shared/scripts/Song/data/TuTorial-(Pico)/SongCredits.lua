...
function onCountdownStarted()
    local songName = 'TuTorial (Pcio-Mix)' -- what's gonna be displayed in the first line
    local songComposer = 'Composer: Adam' -- what's gonna be displayed in the second line
    local charter = 'Charter: Adam' -- what's gonna be displayed in the third line
    local extraText = 'Pico-Engine: Lucas' -- what's gonna be displayed na quarta linha.
