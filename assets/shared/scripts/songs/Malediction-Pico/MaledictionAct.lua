...
function onTimerCompleted(tag, loops, loopsLeft)
	if tag == 'startText' then
		...
		--CIRCLE
		makeLuaSprite('circle', 'Act/ActLite/template', 777, 0);
		setObjectCamera('circle', 'other');
		doTweenColor('circleColorTween', 'circle', '343a70', 0.01, 'linear')
		addLuaSprite('circle', true);
		--TEXT BACK
		makeLuaText("titlecardback", 'MALEDICTION', 1000 , -994, 305);
		...
		--TEXT
		makeLuaText("titlecard", 'MALEDICTION', 1000 , -1000, 300);
		...
		--ENCORE BACK
		makeLuaText("ENCOREB", 'ENCORE', 1000 , 360, 164);
		...
		--addLuaText('ENCOREB')
		--ENCORE
		makeLuaText("ENCORE", 'ENCORE', 1000 , 360, 170);
