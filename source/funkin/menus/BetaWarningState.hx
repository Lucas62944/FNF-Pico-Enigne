...
class BetaWarningState extends MusicBeatState {
	...
	public override function create() {
		...
		disclaimer.applyMarkup('This engine is still in a *${Main.releaseCycle}* state. That means *majority of the features* are either *buggy* or *non finished*. If you find any bugs, please report them to the  PicoEngine GitHub.\n\nPress ENTER to continue',
			[
