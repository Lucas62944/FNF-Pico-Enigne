package lucas.funkin.vslice.stages.erect;

import openfl.filters.BlurFilter;
import lucas.states.vslice.shaders.AdjustColorShader;
...
import lucas.states.vslice.options.VsliceOptions;
...
class PhillyStreetsErect extends BaseStage
    ...
    function updateMist(elapsed:Float) {
        ...
        override function createPost()
        {
            ...
            paper.animation.addByPrefix('idle', 'Paper Blowing instance 1', 24, false);
            paper.scale.set(1.1, 1.1);

        if (PlayState.SONG.song.toLowerCase() == "2hot-(bf)")
        {
