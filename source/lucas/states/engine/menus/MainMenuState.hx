package lucas.states.engine.menus;
...
class MainMenuState extends MusicBeatState
{
	...
	['story_mode', 'freeplay', 'credits', #if MODS_ALLOWED 'mods' #end];
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Pico-Engine V" + PicoEngineVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("vcr.ttf", 16, FlxColor.GREEN, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);

		#if mobile
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Pico-EngineV" + Application.current.meta.get('version'), 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("vcr.ttf", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		#end

		var psychVer:FlxText = new FlxText(12, FlxG.height - 44, 0, "PsychEngineV" + EngineVersion, 12);
		...
		if (showOutdatedWarning && ClientPrefs.data.checkForUpdates && substates.OutdatedSubState.updateVersion != PicoEngineVersion) {
	...
	function createMenuItem(name:String, x:Float, y:Float):FlxSprite
	{
		...
		menuItem.frames = Paths.getSparrowAtlas('Menus/Main-Menu/menu_$name');
