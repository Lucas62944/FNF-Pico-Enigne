package lucas.states.funkin.scripts.menus;
...
class FreeplayState extends MusicBeatState
{
	...
	function weekIsLocked(name:String):Bool
	{
		...
		return (!leWeek.startUnlocked && leWeek.weekBefore.length > 0 && (!lucas.states.funkin.scripts.modes.StoryMenuState.weekCompleted.exists(leWeek.weekBefore) || !lucas.states.funkin.scripts.modes.StoryMenuState.weekCompleted.get(leWeek.weekBefore)));
	}
