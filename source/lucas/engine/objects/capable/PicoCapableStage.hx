package lucas.engine.objects.capable;
...
import lucas.engine.objects.ABotPixel;
...
class PicoCapableStage extends BaseStage
{
    ...
    public static var NENE_LIST = ['nene','nene-pixel', 'nene-christmas', 'nene-dark', 'nene-wii'];
    public static var PIXEL_LIST = ['nene-pixel'];
    public static var WII_LIST = ['nene-wii'];

    public var abot:ABotSpeaker;
    public var abotPixel:ABotPixel;
    public var abotWii:ABotPixel;
