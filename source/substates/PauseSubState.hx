...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItemsOG:Array<String> = ['Resume', 'Restart', 'Difficulty', 'Options', 'Exit to menu'];
	...
	override function create()
	{
		...
		var DeathsTxt:FlxText = new FlxText(20, 15 + 64, 0, Language.getPhrase("Deaths", "{1} Deaths", [PlayState.deathCounter]), 32);
		DeathsTxt.scrollFactor.set();
		DeathsTxt.setFormat(Paths.font(PlayState.isPixelStage ? "pixel.otf" : 'PhantomMuff.ttf'), PlayState.isPixelStage ? 20 : 32, FlxColor.fromRGB(0, 255, 255), null, OUTLINE, FlxColor.BLACK);
		DeathsTxt.setFormat(Paths.font('vcr.ttf'), 32);
		DeathsTxt.updateHitbox();
		add(DeathsTxt);

		practiceText = new FlxText(20, 15 + 101, 0, Language.getPhrase("Practice").toUpperCase(), 32);
