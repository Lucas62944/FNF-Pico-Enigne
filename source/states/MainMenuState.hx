...
{
	public static var PicoVersion:String = '2.3.4'; // This is also used for Discord RPC + base game of mod
	public static var PsychVersion:String = '1.0.4';
	public static var FunkinVersion:String = '0.8.1'; // V-Slice version of Friday Night Funkin'
