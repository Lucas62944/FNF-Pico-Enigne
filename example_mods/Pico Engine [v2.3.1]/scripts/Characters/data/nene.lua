...
function onCreatePost()
    ...
    addLuaScript('scripts/characters/data/props/abot-speaker')
    callScript('scripts/characters/data/props/abot-speaker', 'createSpeaker', {'nene', 0, 0}) -- {characterName, offsetX, offsetY}
